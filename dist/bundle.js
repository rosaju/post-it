...
var _formTextarea = __webpack_require__(74);

var _formTextarea2 = _interopRequireDefault(_formTextarea);

var _formButton = __webpack_require__(75);
...
function criaComponenteTextareaTexto(notaAlterada, posicao) {
    var props = {
        ...
        onChange: function onChange(event) {
            return notaAlterada.texto = event.target.value;
        }
    };
...
function criaComponenteButtonConcluido(notaAlterada, adicionarNota) {
    var props = {
        ...
        children: 'Concluído',
        onClick: function onClick(event) {
            return adicionarNota(notaAlterada.titulo, notaAlterada.texto, event.target.form, notaAlterada.posicao);
        }
    };
...
function FormNotas(_ref) {
    ...
    var notaAlterada = new _nota2.default(notaAtual.posicao, notaAtual.titulo, notaAtual.texto, notaAtual.editando);

    var inputTitulo = criaComponenteInputTitulo(notaAlterada);
    var textareaTexto = criaComponenteTextareaTexto(notaAlterada);
    var buttonRemover = criaComponenteButtonRemover(notaAlterada, removerNota);
    var buttonConcluido = criaComponenteButtonConcluido(notaAlterada, adicionarNota);

    var props = { className: 'note' };
    if (notaAlterada.estaVisualizando()) {
        props.onClick = function () {
            return editarFormulario(notaAlterada.posicao);
        };
    }
...
throw new Error("Module build failed: C:/Users/05980940910/Desktop/post-it/src/reducers.js: Duplicate declaration \"estadoNovo\"\n\n\u001b[0m \u001b[90m 18 | \u001b[39m\n \u001b[90m 19 | \u001b[39m        \u001b[36mcase\u001b[39m \u001b[33mREMOVER_NOTA\u001b[39m\u001b[33m:\u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 20 | \u001b[39m            \u001b[36mconst\u001b[39m estadoNovo \u001b[33m=\u001b[39m {\n \u001b[90m    | \u001b[39m                  \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 21 | \u001b[39m                notas\u001b[33m:\u001b[39m estadoAtual\u001b[33m.\u001b[39mnotas\u001b[33m.\u001b[39mfilter((nota\u001b[33m,\u001b[39m posicao) \u001b[33m=>\u001b[39m {\n \u001b[90m 22 | \u001b[39m                    \u001b[36mreturn\u001b[39m posicao \u001b[33m!==\u001b[39m acao\u001b[33m.\u001b[39mposicao\n \u001b[90m 23 | \u001b[39m                })\u001b[0m\n");
...
var _listaNotas = __webpack_require__(72);
...
var _secaoNotas = __webpack_require__(77);
...
function Page(_ref) {
    var listaNotas = _ref.listaNotas,
        adicionarNota = _ref.adicionarNota,
        removeNota = _ref.removeNota,
        editarFormulario = _ref.editarFormulario;

    var props = { className: 'container' };

    var formNotas = montaFormNotas(adicionarNota, removeNota, editarFormulario);
    var SecaoNotas = montaSecaoNotas(listaNotas, adicionarNota, removeNota, editarFormulario);
...
"use strict";
throw new Error("Module build failed: SyntaxError: C:/Users/05980940910/Desktop/post-it/src/componentes/secaoNotas.js: Unexpected token (29:8)\n\n\u001b[0m \u001b[90m 27 | \u001b[39m        {listaNotas\u001b[33m.\u001b[39mmap((notaAtual\u001b[33m,\u001b[39m posicao) \u001b[33m=>\u001b[39m \n \u001b[90m 28 | \u001b[39m            \n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 29 | \u001b[39m        )}\n \u001b[90m    | \u001b[39m        \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 30 | \u001b[39m}\n \u001b[90m 31 | \u001b[39m\n \u001b[90m 32 | \u001b[39m\u001b[36mexport\u001b[39m \u001b[36mdefault\u001b[39m \u001b[33mSecaoNotas\u001b[39m\u001b[0m\n");
